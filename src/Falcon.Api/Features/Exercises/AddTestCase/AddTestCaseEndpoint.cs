...
public class AddTestCaseEndpoint : IEndpoint
{
    ...
    {
        app.MapPost(
                "api/Exercise/{id}/testcase",
                [Authorize(Roles = "Teacher,Admin")]
                async (IMediator mediator, Guid id, [FromBody] AddTestCaseCommand command) =>
                {
            ...
            .WithDescription(
                "Adds a test case to the specified exercise. Requires Teacher or Admin role; route id must match command.ExerciseId."
            )
