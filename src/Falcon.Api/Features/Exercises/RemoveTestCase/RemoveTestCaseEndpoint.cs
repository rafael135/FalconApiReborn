...
public class RemoveTestCaseEndpoint : IEndpoint
{
    ...
    {
        app.MapDelete(
                "api/Exercise/{exerciseId}/testcase/{testCaseId}",
                [Authorize(Roles = "Teacher,Admin")]
                async (IMediator mediator, Guid exerciseId, Guid testCaseId) =>
                {
            ...
            .WithDescription(
                "Removes a test case from the specified exercise. Requires Teacher or Admin role."
            )
