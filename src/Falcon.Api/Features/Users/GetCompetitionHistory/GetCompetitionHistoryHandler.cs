...
/// </summary>
public class GetCompetitionHistoryHandler : IRequestHandler<GetCompetitionHistoryQuery, GetCompetitionHistoryResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var participations = await _dbContext.UserCompetitionParticipations
            .AsNoTracking()
        ...
        foreach (var participation in participations)
        {
            ...
            historyList.Add(new CompetitionHistoryDto(
                competition.Id,
                competition.Name,
        ...
        var paginatedHistory = historyList
            .Skip(request.Skip)
            .Take(request.Take)
            .ToList();
