...
public class InviteUserEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost(
                "api/Group/invite",
                [Authorize]
                async (IMediator mediator, [FromBody] InviteUserCommand command) =>
                {
            ...
            .WithDescription(
                "Sends an invitation to the specified user to join the authenticated user's group. Requires group leadership."
            )
