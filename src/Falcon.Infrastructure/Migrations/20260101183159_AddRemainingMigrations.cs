...
namespace Falcon.Infrastructure.Migrations
{
    ...
    public partial class AddRemainingMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_GroupInvites_GroupId", table: "GroupInvites");

            migrationBuilder.DropIndex(name: "IX_GroupInvites_GroupId1", table: "GroupInvites");
            ...
            migrationBuilder.DropColumn(name: "GroupId1", table: "GroupInvites");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<double>(
                        type: "float",
                        nullable: false,
                        defaultValue: 0.0
                    ),
                    Penalty = table.Column<double>(
                        type: "float",
                        nullable: false,
                        defaultValue: 0.0
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_GroupsInCompetitions",
                        x => new { x.GroupId, x.CompetitionId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(name: "IX_Logs_GroupId", table: "Logs", column: "GroupId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "AttachedFiles");

            migrationBuilder.DropTable(name: "CompetitionRankings");

            migrationBuilder.DropTable(name: "GroupExerciseAttempts");

            migrationBuilder.DropTable(name: "GroupsInCompetitions");
            ...
            migrationBuilder.DropIndex(name: "IX_Exercises_AttachedFileId", table: "Exercises");
            ...
            migrationBuilder.DropColumn(name: "AttachedFileId", table: "Exercises");
